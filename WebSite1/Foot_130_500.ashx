<%@ WebHandler Language="C#" Class="Foot_130_500" %>
...
public class Foot_130_500 : IHttpHandler {
    public struct Array
    {
        public double dis;
        public double time;

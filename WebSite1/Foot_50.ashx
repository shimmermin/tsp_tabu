<%@ WebHandler Language="C#" Class="Foot_50" %>
...
public class Foot_50 : IHttpHandler {
    public struct Array
    {
        public double dis;
        public double time;

<%@ WebHandler Language="C#" Class="Foot_130_900" %>
...
public class Foot_130_900 : IHttpHandler {
    public struct Array
    {
        public double dis;
        public double time;

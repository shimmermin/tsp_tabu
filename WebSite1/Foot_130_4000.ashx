<%@ WebHandler Language="C#" Class="Foot_130_4000" %>
...
public class Foot_130_4000 : IHttpHandler {
    public struct Array
    {
        public double dis;
        public double time;
